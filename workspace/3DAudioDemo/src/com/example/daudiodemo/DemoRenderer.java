...
public class DemoRenderer implements GLSurfaceView.Renderer 
{
    ...
    public volatile float caliRoll = SensorHubService.caliRoll;
    public volatile float caliPitch = SensorHubService.caliPitch;
    public volatile float caliYaw = SensorHubService.caliYaw;
...
*/		
     ...
     // Draw some pyramids.        
       ...
       // drawLight();
		...
		final float lookX = 5.0f*FloatMath.cos(SensorHubService.caliRoll)*FloatMath.sin(SensorHubService.caliPitch);
		System.out.println("caliRoll " + caliRoll);
		final float lookY = 5.0f*FloatMath.cos(SensorHubService.caliPitch); 
		final float lookZ = 5.0f*FloatMath.sin(SensorHubService.caliRoll)*FloatMath.sin(SensorHubService.caliPitch)-6.0f;
