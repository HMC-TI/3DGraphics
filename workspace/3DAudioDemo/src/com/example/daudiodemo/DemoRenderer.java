...
public class DemoRenderer implements GLSurfaceView.Renderer {
	...
	protected String getVertexShader() {
		...
		final String vertexShader = "uniform mat4 u_MVPMatrix;      \n" // A
				 ...
				 * normal. If the normal and light vector are // pointing in the
				 * same direction then it will get max illumination. +
	...
	public void onDrawFrame(GL10 glUnused) {
		...
		/*
		 * Random rand = new Random(); if (found) { pyrX = rand.nextFloat()*8 -
		 * 4.0f; pyrY = rand.nextFloat()*8 - 4.0f; pyrZ = rand.nextFloat()*(-8)
		 * - 2.0f; }
		 */
		...
		if (upRotate) {
			// will not rotate above a top view; prevents view from flipping
			// when viewing behind
