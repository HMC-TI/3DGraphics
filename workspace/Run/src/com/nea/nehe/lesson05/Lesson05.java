...
public class Lesson05 implements Renderer {
	...
	/** Pyramid instance */
	private Pyramid topHalf;
	private Pyramid bottomHalf;
	/** Cube instance */
	private Cube cube;
...
//		cube.draw(gl);							//Draw the Cube
		...
		gl.glTranslatef(0.0f, 1.0f, -6.0f);		//Move up 1.0 Units and -6.0 as the origin matrix is loaded before		
		gl.glRotatef(rtri, 0.0f, 1.0f, 0.0f);	//Rotate The Triangle On The Y axis
		topHalf.draw(gl);						//Draw the Pyramid
		...
		gl.glRotatef(rtri, 0.0f, 1.0f, 0.0f);	//Rotate The Triangle On The Y axis
		bottomHalf.draw(gl);					//Draw the Pyramid
