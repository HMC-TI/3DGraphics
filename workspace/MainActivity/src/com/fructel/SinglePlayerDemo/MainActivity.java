package com.fructel.SinglePlayerDemo;
...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mButtons[GametelKey.NAVIGATION_UP.ordinal()] =   (ImageView)findViewById(R.id.ivUp);
        mButtons[GametelKey.NAVIGATION_LEFT.ordinal()] = (ImageView)findViewById(R.id.ivLeft);
        mButtons[GametelKey.NAVIGATION_RIGHT.ordinal()] =(ImageView)findViewById(R.id.ivRight);
        mButtons[GametelKey.NAVIGATION_DOWN.ordinal()] = (ImageView)findViewById(R.id.ivDown);
        mButtons[GametelKey.ACTION_UP.ordinal()] =       (ImageView)findViewById(R.id.ivA);
        mButtons[GametelKey.ACTION_RIGHT.ordinal()] =    (ImageView)findViewById(R.id.ivB);
        mButtons[GametelKey.ACTION_DOWN.ordinal()] =     (ImageView)findViewById(R.id.ivC);
        mButtons[GametelKey.ACTION_LEFT.ordinal()] =     (ImageView)findViewById(R.id.ivD);
        mButtons[GametelKey.START.ordinal()] =           (ImageView)findViewById(R.id.ivStart);
        mButtons[GametelKey.SELECT.ordinal()] =          (ImageView)findViewById(R.id.ivSelect);
        mButtons[GametelKey.TRIGGER_LEFT.ordinal()] =    (ImageView)findViewById(R.id.ivLTrig);
        mButtons[GametelKey.TRIGGER_RIGHT.ordinal()] =   (ImageView)findViewById(R.id.ivRTrig);
    ...
    private void setButtonIndicator(GametelKey key, boolean pressed) {
           int resId = pressed ? R.drawable.indicator_on : R.drawable.indicator_off;
